...
const Video = () => {
  return (
    <div className='video-wrapper'>
       <div className='container d-flex flex-column justify-content-between align-items-center' style={{height:'100%'}}>
           <img src={vicon} alt="" />
           <div className='video-head-text d-flex justify-content-center'>
    <h2>Usage<span>Video</span></h2>
       </div>
       <Loaders/>
       <p className='videopara'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply
