                ...
                <div className="row d-flex">
                  <div className="col-12 col-sm-6">
                    ...
                    <div className="d-flex flex-column">
                      <span>Name</span>
                      <input type="text" className="smallin" placeholder="Enter your name"/>{" "}
                    </div>
                  </div>
                  <div className="col-12 col-sm-6">  <div className="d-flex flex-column">
                      <span>Name</span>
                      <input type="text" className="smallin" placeholder="Enter your email"/>{" "}
                    </div></div>
                </div>
                <div className="col-12">
                <div className="d-flex flex-column">
                      <span>Name</span>
                      <input type="text" placeholder="Write message" className="bigin"/>{" "}
                    </div>
                </div>
              </div>
            </div>
